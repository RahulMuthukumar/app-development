  ...
  return (
    <div className="dashboard">
      <div className="sidebar">
        <div className="sidebar-heading">Voter Dashboard</div>
        <ul className="sidebar-menu">
          ...
          >
            ...
            <span className="sidebar-menu-item-text">Add Vote</span>
          </li>
          <li
            className={`sidebar-menu-item ${
              currentPage === 'reports' ? 'active' : 'WorkPage'
          ...
          >
            <span className="sidebar-menu-item-icon"></span>
            <span className="sidebar-menu-item-text"><a href='/ExisPol'>Vote Results</a></span>
          </li>
