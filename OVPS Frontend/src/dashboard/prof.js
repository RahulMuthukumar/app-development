          ...
          <div className="author-card pb-3">
            ...
            <div className="author-card-profile">
              <div className="author-card-avatar">
                ...
                <span className="author-card-position">Joined August 31 2004</span>
              </div>
            </div>
          </div>
              ...
              <a className="list-group-item" href="#">
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <div className="d-inline-block font-weight-medium text-uppercase">Name</div>
                  </div>
                  <span className="badge badge-secondary">Admin</span>
                </div>
              </a>
              <a className="list-group-item active" href="#">
                <i className="fe-icon-user text-muted"></i>
              </a>
              <a className="list-group-item" href="#">
          ...
          <form className="row">
            <div className="col-md-6">
              <div className="form-group">
                ...
                <input className="form-control" type="text" id="account-fn" value="Rahul" required />
              </div>
            </div>
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="account-ln">Last Name</label>
                <input className="form-control" type="text" id="account-ln" value="Rohit" required />
              </div>
            </div>
            <div className="col-md-6">
              <div className="form-group">
            ...
            <div className="col-md-6">
              <div className="form-group">
                ...
                <input className="form-control" type="text" id="account-phone" value="+ 9931052599" required />
              </div>
            </div>
            <div className="col-md-6">
              <div className="form-group">
